        ...
        <div className="flex justify-between items-center w-full max-w-[1400px] mx-auto px-4 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 border border-slate-400 dark:border-[#21262d] rounded-full px-3 py-1.5 text-sm text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors whitespace-nowrap"
            >
            ...
            <div className="p-6 flex flex-col gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-800/95 dark:text-blue-400/70 mt-0.5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-green-800/95 dark:text-green-400/70 mt-0.5">
