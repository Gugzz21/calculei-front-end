      ...
      >
        ...
        <div className="hidden md:contents text-[13px] text-gray-700">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              onClick={(e) => { e.stopPropagation(); /* duplicate not implemented yet */ }}
              className="text-gray-500 hover:text-blue-600 transition-colors"
              title="Duplicar"
            >
        ...
        <div className="flex flex-col md:hidden text-[13px] text-gray-700 w-full gap-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={(e) => { e.stopPropagation(); }} className="p-1 text-gray-500 hover:text-blue-600 transition-colors">
                <ContentCopyIcon fontSize="small" />
              </button>
