    ...
    <div className="w-full sm:w-auto">
      <button
        ...
        className={`flex justify-center items-center px-4 gap-3 w-full sm:w-[288px] h-[40px] rounded-md font-semibold text-sm transition-colors
          ${isDisabled
            ? "bg-[#f1f3f5] dark:bg-slate-700 text-[#adb5bd] dark:text-slate-400 cursor-not-allowed"
            : editMode
              ? "bg-amber-500 text-white hover:bg-amber-600 cursor-pointer"
              : "bg-[#073365] dark:bg-blue-600 text-white hover:bg-[#062953] dark:hover:bg-blue-700 cursor-pointer"
          }`}
      >
