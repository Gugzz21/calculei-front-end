      ...
      tabs: [
        {
          ...
          content: (
            ...
            <div className="space-y-4 text-sm text-gray-800 dark:text-gray-300">
              ...
              <div className="p-3 bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-500 rounded-r text-sm">
        ...
        },
        {
          ...
          content: (
            ...
            <div className="space-y-4 text-sm text-gray-800 dark:text-gray-300">
              ...
              <div className="p-3 bg-red-50 dark:bg-red-900/10 border-l-4 border-red-500 rounded-r text-sm">
