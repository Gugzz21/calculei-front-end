...
function InputValor({ value, onChange }: InputValorProps) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full md:w-auto">
      ...
      <div className="bg-white dark:bg-[#010409] border border-slate-400 dark:border-[#21262d] h-[45px] flex items-center px-3 gap-2 rounded-lg w-full md:w-[220px] transition-all duration-200 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 hover:border-slate-500 dark:hover:border-slate-500">
        <input
          ref={inputRef}
          type="text"
          id="valor"
