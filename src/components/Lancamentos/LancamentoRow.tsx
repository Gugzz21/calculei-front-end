...
function LancamentoRow({ item, index, onRemover }: LancamentoRowProps) {
  ...
  return (
    <div className="flex flex-col bg-white border border-gray-200 rounded-xl overflow-hidden transition-all shadow-sm hover:shadow-md">
      ...
      <div 
        className="flex flex-col md:grid md:grid-cols-[2.5rem_minmax(0,1fr)_10rem_8rem_9rem_4rem] md:items-center gap-4 p-4 cursor-pointer select-none hover:bg-gray-50/50 transition-colors group"
