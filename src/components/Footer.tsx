...
function Footer() {
    return (
        <div className="flex bg-white dark:bg-slate-800 w-full py-4 shadow-[0_-1px_4px_rgba(0,0,0,0.1)] dark:shadow-[0_-1px_4px_rgba(0,0,0,0.5)] min-h-[60px] mt-4 transition-colors duration-200">
